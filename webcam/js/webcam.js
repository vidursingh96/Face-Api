...
var Webcam = {
	...
	attach: function(elem) {
		...
		if (this.userMedia) {
			...
			const video2 = document.getElementById('facecam')
			...
			function startVideo() {
              navigator.mediaDevices.getUserMedia({video: {}}).then((stream)=> {video2.srcObject = stream;}, (err)=> console.error(err));
            }
