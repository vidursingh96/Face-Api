(function (global, factory) {
  ...
  function denseBlock4(x, denseBlockParams, isFirstLayer, isScaleDown) {
      ...
      return Ze(function () {
          ...
          var out5 = depthwiseSeparableConv(out4, denseBlockParams.conv4, [1, 1]);
          return Bl(rc(out1, rc(out2, rc(out3, rc(out4 , out5)))));
      });
  }
  ...
  function extractorsFactory(extractWeights, paramMappings) {
      ...
      function extractDenseBlock4Params(channelsIn, channelsOut, mappedPrefix, isFirstLayer) {
          ...
          var conv4 = extractSeparableConvParams(channelsOut, channelsOut, mappedPrefix + "/conv4");
          return { conv0: conv0, conv1: conv1, conv2: conv2, conv3: conv3, conv4: conv4 };
      }
      return {
  ...
  function extractParams(weights) {
      ...
      var dense4 = extractDenseBlock4Params(256, 512, 'dense4');
  ...
  function loadParamsFactory(weightMap, paramMappings) {
      ...
      function extractDenseBlock4Params(prefix, isFirstLayer) {
          ...
          var conv4 = extractSeparableConvParams(prefix + "/conv4");
          return { conv0: conv0, conv1: conv1, conv2: conv2, conv3: conv3, conv4: conv4 };
      }
      return {
          extractDenseBlock3Params: extractDenseBlock3Params,
  ...
  function extractParamsFromWeigthMap(weightMap) {
      ...
      var params = {
          ...
          dense4: extractDenseBlock4Params('dense4'),
      };
  ...
  var FaceFeatureExtractor = /** @class */ (function (_super) {
      ...
      FaceFeatureExtractor.prototype.forwardInput = function (input) {
          ...
          return Ze(function () {
              ...
              out = denseBlock4(out, params.dense4);
